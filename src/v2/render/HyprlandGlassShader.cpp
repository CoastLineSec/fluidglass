...
Result<void> HyprlandGlassShader::cacheUniforms() {
  ...
  const std::array required{
      m_uniforms.capture,        m_uniforms.sourceTL,
      m_uniforms.sourceTR,       m_uniforms.sourceBR,
      m_uniforms.sourceBL,       m_uniforms.fullSize,
      m_uniforms.clipOffset,     m_uniforms.clipSize,
      m_uniforms.shapeKind,      m_uniforms.radius,
      m_uniforms.roundingPower,  m_uniforms.ringRadius,
      m_uniforms.ringThickness,  m_uniforms.baseEnabled,
      m_uniforms.baseRadii,      m_uniforms.cutoutEnabled,
      m_uniforms.cutoutRect,     m_uniforms.cutoutRadii,
      m_uniforms.partCount,      m_uniforms.partRects,
      m_uniforms.partRadii,      m_uniforms.partJunctions,
      m_uniforms.partOpacity,    m_uniforms.connectorCount,
      m_uniforms.connectorRects, m_uniforms.connectorCurve,
      m_uniforms.blurPixels,     m_uniforms.refractionPixels,
      m_uniforms.edgeBandPixels, m_uniforms.bevelPixels,
      m_uniforms.rimWidthPixels, m_uniforms.lensBandPixels,
      m_uniforms.highlight,      m_uniforms.shadow,
      m_uniforms.specular,       m_uniforms.chroma,
      m_uniforms.edgeDepth,      m_uniforms.lens,
      m_uniforms.gloss,          m_uniforms.tint,
      m_uniforms.veilSaturation, m_uniforms.lightDirection,
      m_uniforms.opacity,
  };
